...
+ (NSString*)_stringByAddingPercentEscapes:(NSString*)string {
    // KEG: CFURLCreateStringByAddingPercentEscapes has been deprecated in iOS10. From the example on https://github.com/mierau/DMTemplates
    // this function is used to supply a modifier for the query portion of a URL.
